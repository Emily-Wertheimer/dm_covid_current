...
state_pops2 <- read_excel("C:/Users/ekw28/ekw_lab_projects/dm_covid/data/state_pops2.xlsx")
...
# create correlation matrix for death rate, hospitalization rate, positive test rate
```{r}

cor(as.numeric(trackerNew))
